...
namespace PureHDF.Tests
{
    public partial class TestUtils
    {
        public static unsafe void AddChunkedDatasetForHyperslab(long fileId)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "hyperslab", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Legacy(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }

        public static unsafe void AddChunkedDatasetWithFillValueAndAllocationLate(long fileId, int fillValue)
        {
            var length = (ulong)ReadingTestData.MediumData.Length;
            var dcpl_id = H5P.create(H5P.DATASET_CREATE);
        ...
        public static unsafe void AddChunkedDataset_Single_Chunk(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_single_chunk", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Implicit(long fileId)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_implicit", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Fixed_Array(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_fixed_array", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Fixed_Array_Paged(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_fixed_array_paged", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Extensible_Array_Elements(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_extensible_array_elements", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims0, dims1, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Extensible_Array_Data_Blocks(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_extensible_array_data_blocks", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims0, dims1, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_Extensible_Array_Secondary_Blocks(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_extensible_array_secondary_blocks", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims0, dims1, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
        ...
        public static unsafe void AddChunkedDataset_BTree2(long fileId, bool withShuffle)
        {
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_btree2", H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), dims0, dims1, cpl: dcpl_id);
        ...
        {
            var length = (ulong)ReadingTestData.HugeData.Length;
            ...
            Add(ContainerType.Dataset, fileId, "chunked", "chunked_huge", H5T.NATIVE_INT32, ReadingTestData.HugeData.AsSpan(), dims, cpl: dcpl_id);
            _ = H5P.close(dcpl_id);
        }
    }
}