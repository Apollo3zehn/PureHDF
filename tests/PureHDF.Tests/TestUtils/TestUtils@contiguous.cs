...
namespace PureHDF.Tests
{
    public partial class TestUtils
    {
        ...
        {
            Add(ContainerType.Dataset, fileId, "contiguous", "contiguous", H5T.NATIVE_INT32, ReadingTestData.HugeData.AsSpan());
        }
        ...
        public static unsafe void AddExternalDataset(long fileId, string datasetName)
        {
            ...
            _ = H5P.set_external(dcpl_id, pathC, new IntPtr(0), (ulong)((ReadingTestData.MediumData.Length - 40) * bytesoftype));

            // write data
            Add(ContainerType.Dataset, fileId, "external", datasetName, H5T.NATIVE_INT32, ReadingTestData.MediumData.AsSpan(), cpl: dcpl_id);
