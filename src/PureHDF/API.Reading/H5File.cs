...
public partial class H5File
{
    ...
    public static NativeFile Open(string filePath, FileMode mode, FileAccess fileAccess, FileShare fileShare, bool useAsync = false)
    {
        return NativeFile.InternalOpen(filePath, mode, fileAccess, fileShare, useAsync: useAsync);
    }
    ...
    public static NativeFile Open(Stream stream, bool leaveOpen = false)
    {
        ...
        return NativeFile.InternalOpen(driver, string.Empty);
    }
    ...
    /// <returns></returns>
    public static NativeFile Open(MemoryMappedViewAccessor accessor)
    {
