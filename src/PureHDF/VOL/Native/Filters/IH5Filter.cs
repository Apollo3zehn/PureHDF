...
public interface IH5Filter
{
    ...
    uint[] GetParameters(H5Dataset dataset, uint typeSize, Dictionary<string, object>? options); /* https://docs.hdfgroup.org/hdf5/develop/group___h5_z.html#ga93145acc38c2c60d832b7a9b0123706b */
}