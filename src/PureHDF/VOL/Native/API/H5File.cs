...
public class H5File
{
    ...
    public static INativeFile OpenRead(string filePath)
    {
        return NativeFile.OpenRead(filePath);
    }
    ...
    public static INativeFile Open(string filePath, FileMode mode, FileAccess fileAccess, FileShare fileShare, bool useAsync = false)
    {
        return NativeFile.Open(filePath, mode, fileAccess, fileShare, useAsync: useAsync);
    }
    ...
    /// <returns></returns>
    public static INativeFile Open(Stream stream, bool leaveOpen = false)
    {
        H5DriverBase driver;
        ...
        return NativeFile.Open(driver, string.Empty);
    }
    ...
    /// <returns></returns>
    public static INativeFile Open(MemoryMappedViewAccessor accessor)
    {
