...
internal abstract class H5D_Base : IDisposable
{
    ...
    public abstract IH5ReadStream GetReadStream(ulong chunkIndex, ulong[] chunkIndices);

    public abstract IH5WriteStream GetWriteStream(ulong chunkIndex, ulong[] chunkIndices);
