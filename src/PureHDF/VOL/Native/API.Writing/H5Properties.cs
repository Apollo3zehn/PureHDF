...
/// </summary>
/// <param name="ChunkCache">The chunk cache used for writing. If <see langword="null"/>, the value of the <see cref="H5WriteOptions.ChunkCacheFactory"/> property is used instead.</param>
