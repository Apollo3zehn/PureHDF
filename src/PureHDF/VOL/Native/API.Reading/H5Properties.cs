...
/// <param name="ChunkCache">The chunk cache used for reading. If <see langword="null"/>, the value of the <see cref="ChunkCache.DefaultReadingChunkCacheFactory"/> property is used instead.</param>
