...
/// <param name="ChunkCacheFactory">The factory to create the chunk cache. If <see langword="null"/>, the factory of the <see cref="NativeFile.ChunkCacheFactory"/> property is used.</param>
