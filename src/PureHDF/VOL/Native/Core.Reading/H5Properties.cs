...
/// <param name="ChunkCache">The chunk cache. If <see langword="null"/>, the chunk cache factory of the <see cref="NativeFile.ChunkCacheFactory"/> property is used.</param>
public readonly record struct H5DatasetAccess(
    string? ExternalFilePrefix = default,
    string? VirtualPrefix = default,
    IChunkCache? ChunkCache = default);
