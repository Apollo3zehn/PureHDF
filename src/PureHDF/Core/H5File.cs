...
partial class H5File
{
        ...
        bool deleteOnClose = false)
    {
        ...
        return OpenCore(driver, absoluteFilePath, deleteOnClose);
    }

    private static H5File OpenCore(H5DriverBase driver, string absoluteFilePath, bool deleteOnClose = false)
    {
