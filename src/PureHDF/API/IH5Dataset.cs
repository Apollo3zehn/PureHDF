...
public interface IH5Dataset : IH5AttributableObject
{
    ...
    IQueryable<T> AsQueryable<T>(Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : unmanaged;
    ...
    byte[] Read(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default);
    ...
    T[] Read<T>(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : unmanaged;
    ...
    /// <param name="memoryDims">The dimensions of the destination memory buffer.</param>
    /// <param name="datasetAccess">The dataset access properties.</param>
    void Read<T>(Memory<T> buffer, Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : unmanaged;
    ...
    /// <param name="datasetAccess">The dataset access properties.</param>
    /// <returns>The read data as array of <typeparamref name="T"/>.</returns>
    T[] ReadCompound<T>(Func<FieldInfo, string>? getName = null, Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : struct;
    ...
    Dictionary<string, object?>[] ReadCompound(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default);
    ...
    Task<byte[]> ReadAsync(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default);
    ...
    Task<T[]> ReadAsync<T>(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : unmanaged;
    ...
    /// <param name="memoryDims">The dimensions of the destination memory buffer.</param>
    /// <param name="datasetAccess">The dataset access properties.</param>
    Task ReadAsync<T>(Memory<T> buffer, Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : unmanaged;
    ...
    /// <param name="datasetAccess">The dataset access properties.</param>
    /// <returns>A task which returns the read data as array of <typeparamref name="T"/>.</returns>
    Task<T[]> ReadCompoundAsync<T>(Func<FieldInfo, string>? getName = null, Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default) where T : struct;
    ...
    Task<Dictionary<string, object?>[]> ReadCompoundAsync(Selection? fileSelection = null, Selection? memorySelection = null, ulong[]? memoryDims = null, H5DatasetAccess datasetAccess = default);
