...
namespace HDF5.NET
{
    public class FixedArrayDataBlock
    {
        ...
        public FixedArrayDataBlock(H5BinaryReader reader, Superblock superblock, FixedArrayHeader header, ulong chunkSizeLength)
        {
            ...
            if (header.EntriesCount > this.ElementsPerPage)
            {
                ...
                this.PageSize = this.ElementsPerPage * header.EntrySize + 4; // 4 = checksum
            }
            ...
            {
                this.Elements = new FixedArrayDataBlockElement[header.EntriesCount];
                ...
                switch (this.ClientID)
                {
                    ...
                    default:
                        throw new Exception($"Client ID '{this.ClientID}' is not supported.");
                }
            }
