...
# check if on v1 branch
if not "* v1" in subprocess.check_output(["git", "branch"], stdin=None, stderr=None, shell=False).decode("utf8"):
    raise Exception("Must be on v1 branch.")
